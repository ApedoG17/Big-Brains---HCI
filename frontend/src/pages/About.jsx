  ...
  return (
    <div style={{ backgroundColor: "#f8f9fa", color: "#0f172a", minHeight: "100vh", padding: "120px 24px 80px 24px", fontFamily: "system-ui, -apple-system, sans-serif" }}>
      <div style={{ maxWidth: "1320px", margin: "0 auto" }}>
        ...
        <div style={{ height: "480px", borderRadius: "32px", overflow: "hidden", marginBottom: "60px", boxShadow: "0 20px 40px rgba(0,0,0,0.08)" }}>
          <img
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: "32px", marginBottom: "80px" }}>
          {[
            ...
            <div key={idx} style={{ background: "#ffffff", borderRadius: "28px", padding: "36px", border: "1px solid #f1f5f9", boxShadow: "0 10px 30px rgba(0,0,0,0.02)" }}>
