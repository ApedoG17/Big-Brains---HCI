    ...
    <div style={{ backgroundColor: "#f8f9fa", minHeight: "100vh", padding: "120px 24px 80px 24px", fontFamily: "system-ui, -apple-system, sans-serif" }}>
      <div style={{ maxWidth: "1320px", margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
          {SERVICES.map((s) => (
            <div key={s.num} style={{ background: "#ffffff", borderRadius: "28px", padding: "36px", border: "1px solid #f1f5f9", display: "grid", gridTemplateColumns: "80px 1fr 280px", gap: "32px", alignItems: "center", boxShadow: "0 10px 30px rgba(0,0,0,0.02)" }}>
              ...
              <div>
                ...
                <p style={{ color: "#64748b", margin: 0, lineHeight: 1.6, fontSize: "0.95rem" }}>
                  {s.desc}
                </p>
              </div>
